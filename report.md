...
- Found in src/SovrynErc20Handler.sol [Line: 63](src/SovrynErc20Handler.sol#L63)
...
- Found in src/TropykusErc20Handler.sol [Line: 65](src/TropykusErc20Handler.sol#L65)
...
- Found in src/DcaManager.sol [Line: 389](src/DcaManager.sol#L389)

	```solidity
	    function modifyMinPurchasePeriod(uint256 minPurchasePeriod) external override onlyOwner {
	```

- Found in src/DcaManager.sol [Line: 397](src/DcaManager.sol#L397)

	```solidity
	    function modifyMaxSchedulesPerToken(uint256 maxSchedulesPerToken) external override onlyOwner {
	```

- Found in src/DcaManager.sol [Line: 632](src/DcaManager.sol#L632)

	```solidity
	        onlyOwner
	```

- Found in src/DcaManager.sol [Line: 642](src/DcaManager.sol#L642)
...
- Found in src/interfaces/ITokenHandler.sol [Line: 19](src/interfaces/ITokenHandler.sol#L19)

	```solidity
	    error TokenHandler__PurchaseAmountMustBeGreaterThanZero();
	```

- Found in src/interfaces/ITokenHandler.sol [Line: 20](src/interfaces/ITokenHandler.sol#L20)

	```solidity
	    error TokenHandler__PurchasePeriodMustBeGreaterThanZero();
	```

- Found in src/interfaces/ITokenHandler.sol [Line: 21](src/interfaces/ITokenHandler.sol#L21)
...
- Found in src/DcaManager.sol [Line: 532](src/DcaManager.sol#L532)

	```solidity
	        for (uint256 i; i < dcaSchedules.length; ++i) {
	```

- Found in src/DcaManager.sol [Line: 704](src/DcaManager.sol#L704)
...
- Found in src/SovrynErc20Handler.sol [Line: 202](src/SovrynErc20Handler.sol#L202)

	```solidity
	        for (uint256 i; i < numOfPurchases; ++i) {
	```

- Found in src/TropykusErc20Handler.sol [Line: 219](src/TropykusErc20Handler.sol#L219)
...
- Found in src/DcaManager.sol [Line: 273](src/DcaManager.sol#L273)

	```solidity
	    function buyRbtc(address buyer, address token, uint256 scheduleIndex, bytes32 scheduleId)
	```

- Found in src/DcaManager.sol [Line: 296](src/DcaManager.sol#L296)
...
- Found in src/SovrynErc20Handler.sol [Line: 111](src/SovrynErc20Handler.sol#L111)

	```solidity
	        _redeemStablecoin(user, stablecoinInterestAmount, exchangeRate, user);
	```

- Found in src/TropykusErc20Handler.sol [Line: 85](src/TropykusErc20Handler.sol#L85)
